...
export default function ThemeBuilder() {
  ...
  const getFormHTML = (type: string): string => {
    ...
    switch(type) {
      ...
      case 'survey': return `<div style="text-align:center"><div style="font-size:48px;margin-bottom:20px">📊</div><h2 style="font-size:28px;font-weight:bold;margin-bottom:24px">Sondage</h2><p style="margin-bottom:16px">Comment trouvez-vous notre service ?</p><label style="display:block;margin-bottom:8px"><input type="radio" name="survey"> Excellent</label><label style="display:block;margin-bottom:8px"><input type="radio" name="survey"> Bon</label><label style="display:block;margin-bottom:8px"><input type="radio" name="survey"> Moyen</label><button style="${baseButtonStyle};margin-top:20px">Voter</button></div>`;

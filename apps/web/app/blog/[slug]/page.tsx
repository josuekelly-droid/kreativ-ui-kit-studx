      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-8 md:p-12">
            <div
              className="prose prose-lg max-w-none prose-headings:text-purple-700 prose-a:text-purple-600 prose-strong:text-gray-800"
        ...
        <div className="mt-12 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-white/90 mb-6">
            Inscrivez-vous à la newsletter pour recevoir les nouveaux articles.
          </p>
          <form
            onSubmit={(e) => {
              e.preventDefault();
